...
public class MyDestructibleMeshExperience : MonoBehaviour
{
    public DestructibleGlobalMeshSpawner destructibleGlobalMeshSpawner;
    public RayGun rayGun; // ***** Reference to RayGun *****
    ...
    private void OnEnable()
    {
        ...
        if (rayGun != null)
        {
            rayGun.OnRayHit += HandleRayHit; // ***** Subscribe to RayGun event *****
        }
    }
    ...
    private void OnDisable()
    {
        ...
        if (rayGun != null)
        {
            rayGun.OnRayHit -= HandleRayHit; // ***** Unsubscribe from RayGun event *****
        }
    }
    private void HandleRayHit(GameObject hitObject) // ***** New method *****
    {
        if (_globalMeshSegments.Contains(hitObject) && hitObject != _destructibleMeshComponent.ReservedSegment)
        {
            _destructibleMeshComponent.DestroySegment(hitObject); // Destroy the mesh segment
        }
    }
